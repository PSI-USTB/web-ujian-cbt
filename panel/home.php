...
$guru = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengawas where level='guru'"));
            ...
            <div class='row'>
                <div class="col-lg-4">
                    <div class="small-box bg-purple ">
                        ...
                        <a href="?pg=siswa" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-green ">
                        ...
                        <a href="?pg=banksoal" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-red ">
                        <div class="inner">
                            <h3><?= $ujian ?></h3>Jadwal Ujian
                        </div>
                        <div class="icon">
                            <i class="fa fa-edit"></i>
                        </div>
                        <a href="?pg=jadwal" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-aqua ">
                        <div class="inner">
                            <h3><?= $guru ?></h3>Data Guru
                        </div>
                        <div class="icon">
                            <i class="fa fa-chalkboard-teacher"></i>
                        </div>
                        <a href="?pg=guru" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-yellow ">
                        ...
                        <a href="?pg=nilaiujian" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="small-box bg-blue ">
                        ...
                        <a href="#" id="btnhapusjawaban" class="small-box-footer">Hapus Data <i class="fa fa-trash"></i></a>
                ...
                <?php if ($setting['server'] == 'lokal') : ?>
                    <div class="col-lg-12">
                        <div class="small-box ">
                            ...
                            <a href="?pg=sinkronset" class="small-box-footer">Lihat Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <script>
                        $.ajax({
