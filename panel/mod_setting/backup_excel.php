...
$spreadsheet->getProperties()
    ->setCreator("CBT Application")
    ->setLastModifiedBy("CBT Application")
    ->setTitle("Office 2007 XLSX for CBT Application")
    ->setSubject("Office 2007 XLSX for CBT Application")
    ->setDescription("Office 2007 XLSX for CBT Application")
    ->setKeywords("Office 2007 XLSX for CBT Application")
    ->setCategory("Office 2007 XLSX for CBT Application");
...
while ($data = mysqli_fetch_array($soal_mapel)) :
    ...
    $i++;
endwhile;
$spreadsheet->getActiveSheet()->setTitle('CBT Application');
