                    ...
                    <div class='form-group'>
                        ...
                        <select name='idmapel' class='form-control' required='true'>
                            ...
                            if ($pengawas['level'] == 'admin') {
                                $namamapelx = mysqli_query($koneksi, "SELECT mapel.id_mapel AS idmapel, mapel.kode AS kodemapel, mapel.nama AS namapel, mapel.level AS level, mapel.kelas as kelas, pengawas.nama AS guru FROM mapel INNER join pengawas on mapel.idguru = pengawas.id_pengawas where status='1' order by namapel ASC");
                            } else {
                            ...
                            while ($namamapel = mysqli_fetch_array($namamapelx)) {
                                ...
                                echo "<option value='$namamapel[idmapel]'>$namamapel[kodemapel] - [$namamapel[guru]] - ";
