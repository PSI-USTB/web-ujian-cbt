                    ...
                    <div class='modal-body'>
                        ...
                        <div class='form-group'>
                            <div class='row'>
                                <div class='col-md-3'>
                                    <label>Jumlah Soal PG</label>
                                    <input type='number' id='soalpg' name='jml_soal' class='form-control' value='50' required='true' />
                                </div>
                                <div class='col-md-3'>
                                    <label>Bobot Soal PG %</label>
                                ...
                                <div class='col-md-3'>
                                    <label>Soal Tampil</label>
                                    <input type='number' id='tampilpg' name='tampil_pg' class='form-control' value='50' required='true' />
                                </div>
                                <div class='col-md-3'>
                                    <label>Opsi</label>
                                    <select name='opsi' class='form-control'>
                        ...
                        <div class='form-group'>
                            <div class='row'>
                                ...
                                <div class='col-md-3'>
                                    <label>KKM</label>
                                    <input type='number' name='kkm' class='form-control' value='70' required='true' />
                                </div>
                            </div>
                        </div>
                        <div class='form-group'>
