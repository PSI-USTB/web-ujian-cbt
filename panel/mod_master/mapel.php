        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                ...
                <div class='box-tools pull-right '>
                    <button class='btn btn-sm btn-flat btn-success' data-toggle='modal' data-target='#tambahmapel'><i class='fa fa-plus'></i> Tambah Mapel</button>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <form action='' method='post' enctype='multipart/form-data'>
                        ...
                        <a href='template/importmapel.xls'><i class='fa fa-file-excel-o'></i> Download Format</a>
