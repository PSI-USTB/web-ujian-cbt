                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <b>Guru Pengampu</b>
                                        <br>
                                        <?php $guru = mysqli_fetch_array(mysqli_query($koneksi, "SELECT pengawas.nama AS nama FROM mapel INNER join pengawas on mapel.idguru = pengawas.id_pengawas where mapel.kode='$kode'")); ?>
